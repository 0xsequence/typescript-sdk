...
export const WebrpcSchemaHash = "c7e8530922bd8ff83b9338cd080808244d972a3a"
...
export class Wallet implements WalletClient {
  ...
  queryKey = {
    ...
    signTypedData: (req: SignTypedDataRequest) => ['Wallet', 'signTypedData', req] as const,
    prepareEthereumTransaction: (req: PrepareEthereumTransactionRequest) => ['Wallet', 'prepareEthereumTransaction', req] as const,
    prepareEthereumContractCall: (req: PrepareEthereumContractCallRequest) => ['Wallet', 'prepareEthereumContractCall', req] as const,
    execute: (req: ExecuteRequest) => ['Wallet', 'execute', req] as const,
    transactionStatus: (req: TransactionStatusRequest) => ['Wallet', 'transactionStatus', req] as const,
    ...
    listWallets: (req: ListWalletsRequest) => ['Wallet', 'listWallets', req] as const,
    getIDToken: (req: GetIDTokenRequest) => ['Wallet', 'getIDToken', req] as const,
  }
...
export class WalletPublic implements WalletPublicClient {
  protected hostname: string
  protected fetch: Fetch
  protected path = '/rpc/WalletPublic/'
  ...
  queryKey = {
    isValidMessageSignature: (req: IsValidMessageSignatureRequest) => ['WalletPublic', 'isValidMessageSignature', req] as const,
    isValidTypedDataSignature: (req: IsValidTypedDataSignatureRequest) => ['WalletPublic', 'isValidTypedDataSignature', req] as const,
  }
