...
type WalletFeeOptionsBridge = WalletFeeOptionsBridgeV1 & {
  selectFeeOption(
    feeOptions: Parameters<NonNullable<SendNativeTransactionParams["selectFeeOption"]>>[0],
...
export type { SendDataTransactionParams, SendNativeTransactionParams, SendTransactionResponse }
