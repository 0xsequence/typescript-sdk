...
describe('OMSWallet publishable key routing', () => {
  it.each([
    ...
    [
      'pk_local_live_project_key',
      'https://api.local.polygon-dev.technology',
      '0'.repeat(96),
      'required'
    ],
    [
    ...
    'derives managed environment configuration from %s',
    (publishableKey, apiUrl, pcr0, walletImportAttestationMode) => {
